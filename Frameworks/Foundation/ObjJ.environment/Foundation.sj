...
p;20;_CPJavaScriptArray.jt;7152;@STATIC;1.0;i;16;CPMutableArray.jt;7112;
objj_executeFile("CPMutableArray.j",YES);
...
if(_5e.location<0||CPMaxRange(_5e)>_5d.length){
...
p;13;CPArray+KVO.jt;13268;@STATIC;1.0;i;9;CPArray.ji;8;CPNull.jt;13223;
objj_executeFile("CPArray.j",YES);
objj_executeFile("CPNull.j",YES);
var _1=objj_getClass("CPObject");
if(!_1){
